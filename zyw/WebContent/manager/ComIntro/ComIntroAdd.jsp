...
<html>
	...
	<head>
		...
		<link href="https://cdn.bootcss.com/bootstrap/2.3.0/css/bootstrap.min.css" rel="stylesheet">
    ...
    <div id="content">
        <div class="panel">
            <div class="inner post">
                <form id="create_topic_form" action="${pageContext.request.contextPath }/servlet/ComIntroServlet?operation=addComIntro" method="post" enctype="multipart/form-data">
                    <fieldset>
